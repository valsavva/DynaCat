...
Local $winW = 406, $winH = 86
	...
	$cbToDropbox = GUICtrlCreateCheckbox("to dropbox", 70, 57)
	GUISetState(@SW_SHOW)
...
Local $includes = "", $cls
	...
	if VerifySVG() Then
		...
		Write('', False)
		Write('<LevelSettings Dificulty="-1" BombCount="7777777" HeroHealth="100" ExplosionClass="clsExplosion"/>', False) ; 
		Write('', False)
