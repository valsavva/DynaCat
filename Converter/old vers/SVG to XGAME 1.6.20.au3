...
Local $ff
	...
	if StringInStr($str, "EnemyRat1") > 0 Then 
		$PointsEnemy = $PointsEnemy + 75
		if $minPointsEnemy > 75 Then $minPointsEnemy = 75
	EndIf
		
	if StringInStr($str, "EnemyRat2") > 0 Then 
		$PointsEnemy = $PointsEnemy + 50
		$minPointsEnemy = 50
	EndIf
	
	if StringInStr($str, "EnemyRat3") > 0 Then 
		$PointsEnemy = $PointsEnemy + 75
		if $minPointsEnemy > 75 Then $minPointsEnemy = 75
	EndIf
	
	if StringInStr($str, "EnemyRat4") > 0 Then 
		$PointsEnemy = $PointsEnemy + 50
		$minPointsEnemy = 50
	EndIf
	
	if StringInStr($str, "EnemyRat5") > 0 Then 
