...
namespace BasicPrimitiveRendering
{
    ...
    public class BasicPrimitives
    {
        ...
        /// <summary>Render Functions.</summary>
        public enum RenderFunction
        {
            /// <summary>Render only the center average point.</summary>
            CenterPoint,
            /// <summary>Render only the points with no lines.</summary>
            Points,
            /// <summary>Render only the lines with no points.</summary>
            Lines,
            /// <summary>Render using a blocky algorithm.</summary>
            Square,
            /// <summary>Render using a smooth algorithm.</summary>
            Circle,
            /// <summary>Render the lines and end points.</summary>
            PointAndLine,
        }
        ...
        public enum Line
        {
            /// <summary>Connected lines.</summary>
            Solid,
            /// <summary>Fragmented lines.</summary>
            Dash,
            /// <summary>Spotted lines.</summary>
            Dotted,
        }
        ...
        /// <summary>Used for line types such as Dash. Determines the size between lines.</summary>
        private float m_fGapSize = 1f;

        /// <summary>Used for line types such as Dash. Determines how many gaps between lines.</summary>
        private float m_fGapNumbers = 1f;

        /// <summary>The render function. Default is PointAndLine.</summary>
        private RenderFunction m_RenderFunction = RenderFunction.PointAndLine;

        /// <summary>The line type. Default is Solid.</summary>
        private Line m_LineType = Line.Solid;
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Get/Set the thickness of the shape's edge. Default is 1f.
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Get/Set the gap size between lines.
        /// </summary>
        //////////////////////////////////////////////////////////////////////////
        public float GapSize
        {
            get { return m_fGapSize; }
            set { m_fGapSize = value; }
        }

        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Get/Set the number of gaps.
        /// </summary>
        //////////////////////////////////////////////////////////////////////////
        public float GapNumbers
        {
            get { return m_fGapNumbers; }
            set { m_fGapNumbers = value; }
        }

        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Get/Set the renderiong function type. Default is PointAndLine.
        /// </summary>
        //////////////////////////////////////////////////////////////////////////
        public RenderFunction RenderFunctionType
        {
            get { return m_RenderFunction; }
            set { m_RenderFunction = value; }
        }

        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Get/Set the line type. Default is Solid.
        /// </summary>
        //////////////////////////////////////////////////////////////////////////
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Set the outline shape to dash lines.
        /// </summary>
        /// <param name="_fGapSize">The gap size between lines.</param>
        /// <param name="_GapNumbers">The numbers of gaps.</param>
        //////////////////////////////////////////////////////////////////////////
        public void SetDashLines(float _fGapSize, float _GapNumbers)
        {
            m_fGapSize = _fGapSize;
            m_fGapNumbers = _GapNumbers;
            m_LineType = Line.Dash;
        }
        ...
        /// <param name="_fGapSize">The gap size between lines.</param>
        /// <param name="_GapNumbers">The numbers of gaps.</param>
        /// <param name="_fThickness">The thickness of the lines.</param>
        //////////////////////////////////////////////////////////////////////////
        public void SetDashLines(float _fGapSize, float _GapNumbers, float _fThickness)
        {
            m_fGapSize = _fGapSize;
            m_fGapNumbers = _GapNumbers;
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Set the outline shape to dotted lines.
        /// </summary>
        /// <param name="_GapNumbers">The numbers of gaps.</param>
        //////////////////////////////////////////////////////////////////////////
        public void SetDottedLines(float _GapNumbers)
        {
            m_fGapNumbers = _GapNumbers;
            m_LineType = Line.Dotted;
        }
        ...
        /// <param name="_fThickness">The thickness of the lines.</param>
        //////////////////////////////////////////////////////////////////////////
        public void SetDottedLines(float _GapNumbers, float _fThickness)
        {
            m_fGapNumbers = _GapNumbers;
            m_fThickness = _fThickness;
            m_LineType = Line.Dotted;
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Set the vector position, based on index.
        /// </summary>
        /// <param name="_nIndex">The index to set to.</param>
        /// /// <param name="_nPos">The new position for this vector.</param>
        //////////////////////////////////////////////////////////////////////////
        public void SetVector(int _nIndex, Vector2 _nPos)
        {
            m_VectorList[_nIndex] = _nPos;
        }
        ...
        /// <para>Vectors are generated using the parametric equation of an ellipse.</para>
        /// </summary>
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Create a beziergon by passing positions of vertices and controls points per side curve.
        /// <para>Definition:</para>
        /// <para>A beziergon (or polybezier) is a closed path composed of Bézier curves.
        /// It is similar to a polygon in that it connects a set of vertices by lines, but
        /// whereas in polygons the vertices are connected by straight lines, in a beziergon
        /// the vertices are connected by Bézier curves. - Wikipedia</para>
        /// </summary>
        /// <param name="_vPositions">List of positional vertices of the beziergon. 
        ///                           Minimum of 3 positions required.</param>
        /// <param name="_vControlPoints">Controls the positional vertices curve. 
        ///                               Required 2 per curved side. (e.g. 3 sides = 6 control points)</param>
        //////////////////////////////////////////////////////////////////////////
        public void CreateBeziergon(Vector2[] _vPositions, Vector2[] _vControlPoints)
        {
            // Run through in reverse for counter-clockwise rendering order.
            for (int i = _vPositions.Length - 1, j = _vControlPoints.Length - 1; i >= 0; --i, j -= 2)
            {
                int nIndex1 = (i > 0) ? i : _vPositions.Length;
                // Create the spline.
                //           Start position,     1st control point,      2nd control point,  final position.
                Beziergon(_vPositions[nIndex1 - 1], _vControlPoints[j - 1], _vControlPoints[j], _vPositions[i]);
            }
        }
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Render the outline shape.
        /// </summary>
        //////////////////////////////////////////////////////////////////////////
        public void RenderOutline()
        {
            RenderCall(m_RenderFunction, m_LineType);
        }

        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Called when the outline shape needs to be rendered.
        /// </summary>
        ...
        //////////////////////////////////////////////////////////////////////////
        public void RenderOutline(float _fAngle, Vector2 _vPivot)
        {
        ...
        /// Called when the outline shape needs to be rendered.
        /// </summary>
        /// <param name="_renderFunction">The render function to use. Default is PointAndLine.</param>
        /// <param name="_lineType">The line type to use. Default is Solid.</param>
        //////////////////////////////////////////////////////////////////////////
        private void RenderCall(RenderFunction _renderFunction, Line _lineType)
        {
            //////////////////////////////////////////////////////////////////////////
            // Validate.
            if ((_renderFunction != RenderFunction.Points && m_VectorList.Count < 2) ||
                m_VectorList.Count <= 0)
                return;
            //
            //////////////////////////////////////////////////////////////////////////
            ...
            switch (_renderFunction)
            {
                case RenderFunction.PointAndLine:
                    {
                        //////////////////////////////////////////////////////////////////////////
                        ...
                        for (int i = m_VectorList.Count - 1; i >= 1; --i)
                        {
                            ...
                            //////////////////////////////////////////////////////////////////////////
                            // Determine which line type to use.
                            switch (_lineType)
                            {
                                case Line.Solid:
                                    {
                                ...
                                case Line.Dash:
                                    {
                                        //////////////////////////////////////////////////////////////////////////
                                        // Local variables.
                                        Vector2 vTempPos = m_vPosition;
                                        Vector2 vDistance = (vPosition2 - vPosition1);
                                        float fGapDistance = fDistance / m_fGapNumbers;
                                        float fScale = (vDistance.X != 0) ? vDistance.X / m_fGapNumbers
                                                                          : (vDistance.Y != 0) ? vDistance.Y / m_fGapNumbers
                                                                                               : 0f;
                                        if (fScale < 0)
                                            fScale *= -1;
                                        //
                                        ...
                                        //////////////////////////////////////////////////////////////////////////
                                        // Run through the number of gaps.
                                        for (int j = (int)m_fGapNumbers - 1; j >= 0; --j)
                                        {
                                            //////////////////////////////////////////////////////////////////////////
                                            // Stretch the pixel between the two vectors.
                                            m_SpriteBatch.Draw(m_Pixel,
                                                               ...
                                                               fAngle,
                                                               new Vector2(0, 0.5f),
                                                               new Vector2(fScale - m_fGapSize + (fGapDistance - fScale), m_fThickness),
                                                               SpriteEffects.None,
                                                               m_fDepth);
                                            //
                                            //////////////////////////////////////////////////////////////////////////

                                            // Increment position to the next gap size.
                                            vTempPos += (vDistance / m_fGapNumbers);
                                            //
                                            //////////////////////////////////////////////////////////////////////////
                                        }
                                        //
                                ...
                                case Line.Dotted:
                                    {
                                        ...
                                        {
                                            //////////////////////////////////////////////////////////////////////////
                                            // Render the points of the primitive.
                                            m_SpriteBatch.Draw(m_Pixel,
                                                               vTempPos + vPosition1,
                                                               null,
                                                               m_OutlineColor,
                                ...
                                case Line.Dash:
                                    {
                                        ...
                                        {
                                            //////////////////////////////////////////////////////////////////////////
                                            // Stretch the pixel to the size of the gap.
                                            m_SpriteBatch.Draw(m_Pixel,
                                                               vTempPos + vPosition1,
                                                               null,
                                                               m_OutlineColor,
                                ...
                                case Line.Dash:
                                    {
                                        ...
                                        for (int j = (int)m_fGapNumbers - 1; j >= 0; --j)
                                        {
                                            ...
                                            // Stretch the pixel between the two vectors.
                                            m_SpriteBatch.Draw(m_Pixel,
                                                              vTempPos + vPosition1 + 0.5f * (vPosition2 - vPosition1),
                                                              null,
                                                              m_OutlineColor,
                                                              fAngle,
                                                              new Vector2(0.5f, 0.5f),
                ...
                case RenderFunction.Points:
                    {
                        ...
                        {
                            // Store positions.
                            vPosition1 = (i > 0) ? m_VectorList[i - 1] : m_VectorList[m_VectorList.Count - 1];
                            vPosition2 = m_VectorList[i];
                    ...
                    break;
                case RenderFunction.CenterPoint:
                    {
                        //////////////////////////////////////////////////////////////////////////
                        // Stretch the pixel between the two vectors.
                        m_SpriteBatch.Draw(m_Pixel,
                                           m_vCentriod + m_vPosition,
                                           null,
                                           m_OutlineColor,
                                           0f,
                                           new Vector2(0.5f, 0.5f),
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Render the fill in shape.
        /// </summary>
        //////////////////////////////////////////////////////////////////////////
        public void RenderFillIn()
        {
            //////////////////////////////////////////////////////////////////////////
            // Validate.
            ...
            m_GraphicsDevice.RasterizerState = rasterizerState1;
        ...
        /// <param name="_vPivot">Position in which to rotate around.</param>
        //////////////////////////////////////////////////////////////////////////
        public void RenderFillIn(float _fAngle, Vector2 _vPivot)
        {
            //////////////////////////////////////////////////////////////////////////
            // Validate.
            if (m_nVertices <= 0 || m_nPrimitives <= 0)
...
//        }
        ...
        //////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Calculate a béziergon using increments.
        /// </summary>
        /// <param name="_vPosition1">Start position.</param>
        /// <param name="_vControlPoint1">First control position.</param>
        /// <param name="_vControlPoint2">Second control position.</param>
        /// <param name="_vPosition2">Final position.</param>
        //////////////////////////////////////////////////////////////////////////
        private void Beziergon(Vector2 _vPosition1, Vector2 _vControlPoint1, Vector2 _vControlPoint2, Vector2 _vPosition2)
        {
            //////////////////////////////////////////////////////////////////////////
            // Calculate the X values.
            float fX1 = _vPosition2.X - 3 * _vControlPoint2.X + 3 * _vControlPoint1.X - _vPosition1.X;
            float fX2 = 3 * _vControlPoint2.X - 6 * _vControlPoint1.X + 3 * _vPosition1.X;
            float fX3 = 3 * _vControlPoint1.X - 3 * _vPosition1.X;
            //
            //////////////////////////////////////////////////////////////////////////

            //////////////////////////////////////////////////////////////////////////
            // Calculate the Y values.
            float fY1 = _vPosition2.Y - 3 * _vControlPoint2.Y + 3 * _vControlPoint1.Y - _vPosition1.Y;
            float fY2 = 3 * _vControlPoint2.Y - 6 * _vControlPoint1.Y + 3 * _vPosition1.Y;
            float fY3 = 3 * _vControlPoint1.Y - 3 * _vPosition1.Y;
            //
            //////////////////////////////////////////////////////////////////////////

            //////////////////////////////////////////////////////////////////////////
            // Calculate the number of segments, within the spline, using the mid-points.
            int nSegments = (int)(Math.Sqrt(Math.Pow((_vControlPoint2.X - _vControlPoint1.X), 2) + Math.Pow((_vControlPoint2.Y - _vControlPoint1.Y), 2)));

            // Create a new list.
            //List<Vector2> vTempList = new List<Vector2>(nSegments);
            //
            //////////////////////////////////////////////////////////////////////////
            ...
            for (int i = nSegments; i >= 0; --i)
            {
                ...
                //////////////////////////////////////////////////////////////////////////
                // Add the new position to the list.
                m_VectorList.Add(new Vector2(fX1 * fTimeCube + fX2 * fTimeSq + fX3 * fTime + _vPosition1.X,
                                             fY1 * fTimeCube + fY2 * fTimeSq + fY3 * fTime + _vPosition1.Y));
                //
                //////////////////////////////////////////////////////////////////////////
            }
            //
